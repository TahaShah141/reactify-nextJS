...
export const postcssConfigJS = `export default {
    plugins: {
      tailwindcss: {},
      autoprefixer: {},
    },
...
export const tailwindConfigJS = `/** @type {import('tailwindcss').Config} */
export default {
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
...
export const eslintrcCJS = `module.exports = {
    root: true,
